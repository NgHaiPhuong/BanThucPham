...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 22, 2024 lúc 10:44 AM
...
(1, 7, 3011, 'Bơ ngon, ngọt, thích', '2024-06-22 09:48:19'),
(2, 4, 3015, 'Rau đắng, không ngon, không hợp khẩu vị ', '2024-06-11 09:49:02'),
(3, 5, 3015, 'Rau khá ngon, không bị ôi thiu như ở các siêu thị khác', '2024-06-06 09:49:41'),
(4, 6, 3010, 'vẫn còn tươi sống, nhiều gạch và thịt ', '2024-06-22 09:50:19'),
(5, 7, 2002, 'Cà chua ngọt, to tròn, nhiều thịt. Nấu canh chua rất ngon ', '2024-06-11 10:00:06'),
(6, 7, 3011, 'Bơ ngọt, ngon, khá là tươi. Giao đến tay không bị nát, dập ở chỗ nào cả', '2024-06-10 10:00:07');
...
(4, 'Trang trại rau sạch Hoàng Hồng', 'Trang tại nằm tại vị trí đắc địa, có sống suối, thiên nhiên ôn hòa, tạo ra 1 chỗ cho rau củ quả phát triển tốt nhất ', 'thuydam@gmail.com', '0987606652', 'Sóc Sơn, Hà Nội ', 'ncc1.jpg'),
(5, 'Trang trại rau sạch Vân Nội', 'Rau sạch Vân Nội nằm trong top trang trại cung cấp rau sạch lớn nhất Việt Nam. Vân Nội chuyên cung cấp các sản phẩm rau uy tín chất lượng tại thành phố Hà Nội. Trang trại này áp dụng những thành tựu khoa học và những ứng dụng công nghệ hiện đại để đưa vào canh tác và sản xuất. ', 'minhtai@gmail.com', '0977737863', ' Vân Nội, Hà Nội ', 'ncc2.jpg');
...
(1, 'admin', 'admin', '3tt', 'NGeff', '4fajfna', '0987606652', '2024-06-19'),
(2, 'admin1', 'abc', 'zanngyn@gmail.com', 'Nguyen The Van', 'Ha Noi', '0916926321', '2024-06-04');
...
(3015, 1, 3, 'Rau chân vịt', '-Rau chân vịt chứa nhiều dinh dưỡng xanh cùng các chất chống oxy hóa tốt cho cơ thể. Nhờ đó mà một số hội chứng như ung thư tuyến tiền liệt, ung thư phổi, ung thư gan... có thể được hạn chế tối đa.', 15000, 10, 'rauchanvit.png', 10);
...
(1, 'user', 'user', 'phuonghai@gmail.com', 'Nguyễn Thị Hải Phương', 'Hưng Yên', '0987606652', '0000-00-00'),
(2, 'phuong2712', 'abcabc', 'thuydam@gmail.com', 'Nguyễn Hải An', 'Lào Cai', '0987606652', '0000-00-00'),
(4, 'thuy', 'abc', 'thuydam@gmail.com', 'Đàm Thị Thủy', 'Hưng Yên', '0977737863', '2024-06-04'),
(5, 'zanngyn', '123', 'vannguyen14001@gmail.com', 'Nguyễn Thế Văn', '144 Tổ 8', '0916926321', '2024-06-06'),
(6, 'username', '123', 'ngvana@gmail.com', 'Nguyễn Minh Tài', 'Ha Noi', '0931456232', '2024-06-12'),
(7, 'phuong', '123456', 'aloao6857@gmail.com', 'Nguyễn Thị Hải Phương', 'HÀ nội', '0987606652', '2024-06-02');
...
--
ALTER TABLE `thanhvien`
  MODIFY `ID_ThanhVien` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
